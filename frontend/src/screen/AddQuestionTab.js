...
import { get_all_paper } from "../action/paper";
import { create_question } from "../action/question";
...
const AddQuestion = () => {
  ...
  useEffect(() => {
    dispatch(get_all_paper());
  }, [dispatch]);

  // grab subject list from redux state
  const getAllPapers = useSelector((state) => state.getAllPapers);
    ...
    <div className="d-grid gap-2 mb-5">
      ...
      <Form className="mb-5" onSubmit={submitHandler}>
        <Form.Group className="mb-3" controlId="formBasicEmail">
          <Form.Label>
            Select Paper or Course that question will be added to
          </Form.Label>
